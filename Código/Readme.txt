...
Cabe destacar que el código para arduino es para pruebas, ya que no posee lógica para conexión a wifi. 

El código para esp32 es el código que está utilizándose oficialmente en el proyecto. 
